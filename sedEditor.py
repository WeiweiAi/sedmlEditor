import libsedml
from libsedml import SedOperationReturnValue_toString,writeSedMLToFile, readSedMLFromFile
import json
import os
...
The validation functionalities could have overlaps with the libSEDML library.
